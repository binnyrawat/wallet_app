        ...
        <div class="custom-container pb-5">
            <div class="row align-items-center pb-4">
                <div class="col-lg-6 col-md-6 col-4">
                    <div class="title">
                        <h2 class="fw-normal">Create Group</h2>
                    </div>
                </div>
            ...
            <div class="row gy-3">
                ...
                <div class="col-12">
                    <div class="transaction-box">
                        <form class="auth-form" action="{{route('user.store-group')}}" name="group_frm" id="group_frm" method="post">
                            @csrf
                            <div class="custom-container">
                                <div class="form-group">
                                    <label for="group_name" class="form-label">Group Name</label>
                                    <div class="form-input">
                                        <input type="text" class="form-control" id="group_name" name="group_name" placeholder="Enter Group Name" maxlength="150" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-input">
                                                <input type="number" class="form-control" id="no_of_week" name="no_of_week" placeholder="Enter No. Of Week/Year/Month" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
