        ...
        <div class="custom-container pb-5">
            <div class="row align-items-center pb-4">
                <div class="col-lg-6 col-md-6 col-4">
                    <div class="title">
                        <h2 class="fw-normal">Group Requests</h2>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    @php
                                        ...
                                        $inputObj->url = route('user.accept-group-request');
                                        $encLink = encryptLink($inputObj);
                                    @endphp
                                    <div class="col-md-12"><button data-id="{{$encLink}}"  class="btn btn-sm btn-success join_group">Join Group</button></div>
            ...
            <div class="mt-3">
                {{ $requestData->links('pagination.default') }}
            </div>
        </div>
    </section>
@endsection
    ...
    <script>
        $(".join_group").on('click',function(){
            ...
            $('<div></div>').appendTo('body')
                .html('<div><h6>Are you sure you want to join this group</h6></div>')
                .dialog({
                modal: true,
                title: 'Join Group',
                zIndex: 10000,
